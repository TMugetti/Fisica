...
{
    private List<MCollider> layer1 = new List<MCollider>();
    private List<MCollider> layer2 = new List<MCollider>();
    void Start()
    {
        var colliders = FindObjectsOfType<MCollider>();
        foreach (MCollider col in colliders)
        {
